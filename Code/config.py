config = {'train': True,  # train or run the model
          ...
          'print_score': 1000000,  # print when a multiple of this score is reached
          'max_score': 1000000,  # end the episode and update q-table when reaching this score
          'resume_score': 500000,  # if dies above this score, resume training from this difficult segment
          }
